    ...
    public abstract class ExpressionVisitor
    {
        ...
        protected virtual MemberAssignment VisitMemberAssignment(MemberAssignment assignment)
        {
            ...
            if (e != assignment.Expression)
            {
                ...
                //{
                //    if (((ConstantExpression)e).Value.IsNull())
                //    {
                //        return assignment;
                //    }
                //}
                ...
                catch (ArgumentException originalException)
                {
                    var message = string.Format(
                        "Argument types do not match for member {0} of type {1}, expected {2} but argument {3} is {4}.",
                        assignment.Member.Name,
                        assignment.Member.DeclaringType,
                        assignment.Member.GetMemberReturnType().Name,
                        assignment.Expression,
                        e.Type);
                    throw new ArgumentException(message, originalException.ParamName, originalException);
                }
